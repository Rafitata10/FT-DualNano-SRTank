CPWindow1::CPWindow1(void)
{
  ...
  //checkbox10
  checkbox10.SetFOwner(this);
  checkbox10.SetClass(lxT("CCheckBox"));
  checkbox10.SetName(lxT("checkbox10"));
  checkbox10.SetTag(0);
  checkbox10.SetX(507);
  checkbox10.SetY(364);
  checkbox10.SetWidth(114);
  checkbox10.SetHeight(25);
  checkbox10.SetHint(lxT(""));
  checkbox10.SetEnable(1);
  checkbox10.SetVisible(1);
  checkbox10.SetColor(lxT("#000001"));
  checkbox10.SetPopupMenu(NULL);
  checkbox10.SetText(lxT("4-Revolutions"));
  checkbox10.SetCheck(0);
  CreateChild(&checkbox10);
  //edit9
  ...
  edit12.SetText(lxT("25"));
  edit12.SetReadOnly(1);
  CreateChild(&edit12);
  //edit16
  edit16.SetFOwner(this);
  edit16.SetClass(lxT("CEdit"));
  edit16.SetName(lxT("edit16"));
  edit16.SetTag(0);
  edit16.SetX(567);
  edit16.SetY(456);
  edit16.SetWidth(70);
  ...
  edit16.SetEnable(1);
  edit16.SetVisible(1);
  edit16.SetColor(lxT("#000001"));
  edit16.SetPopupMenu(NULL);
  edit16.SetText(lxT("0"));
  edit16.SetReadOnly(1);
  CreateChild(&edit16);
  //label10
  ...
  CreateChild(&label15);
  //label16
  label16.SetFOwner(this);
  label16.SetClass(lxT("CLabel"));
  label16.SetName(lxT("label16"));
  label16.SetTag(0);
  label16.SetX(477);
  label16.SetY(458);
  label16.SetWidth(87);
  label16.SetHeight(20);
  label16.SetHint(lxT(""));
  label16.SetEnable(1);
  label16.SetVisible(1);
  label16.SetColor(lxT("#000001"));
  label16.SetPopupMenu(NULL);
  label16.SetText(lxT("2-Rev (rpm)"));
  label16.SetAlign(1);
  CreateChild(&label16);
  //timer1
